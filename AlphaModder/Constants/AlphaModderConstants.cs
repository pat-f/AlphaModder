...
namespace AlphaModder.Constants
{
    ...
    {
        public const String VERSION = "1.2.0-beta";
        ...
        public const String PRESETS_FOLDER_RELATIVE_PATH = "AlphaModderData\\presets\\";
        public const String ALPHA_FILES_FOLDER_RELATIVE_PATH = "AlphaModderData\\saved-alpha-files\\";
